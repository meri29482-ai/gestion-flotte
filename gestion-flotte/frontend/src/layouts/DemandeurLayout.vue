  ...
  <div id="demandeur-layout" class="d-flex flex-column vh-100">
    ...
    <header class="header d-flex align-items-center justify-content-between px-4 shadow-sm">
      <div class="logo d-flex align-items-center">
        ...
        <h1 class="ms-2 text-sonatrach">Gestion Parc - Demandeur</h1>
      </div>

      <nav class="d-flex align-items-center gap-4 position-relative">
        <!-- Profil -->
        <div class="profil d-flex align-items-center me-2" style="cursor: pointer" @click="$router.push('/demandeur/profil')">
    ...
    <div class="flex-grow-1 d-flex overflow-hidden">
      ...
      <aside class="sidebar bg-light border-end">
        <ul class="nav flex-column py-3">
          <li class="nav-item">
            <router-link to="/demandeur/dashboard" class="nav-link" exact-active-class="active">
              <i class="bi bi-speedometer2 me-2"></i> Tableau de bord
            </router-link>
          </li>
          <li class="nav-item">
            <router-link to="/demandeur/nouvelle-demande" class="nav-link" exact-active-class="active">
              <i class="bi bi-plus-circle me-2"></i> Nouvelle Demande
            </router-link>
          </li>
          <li class="nav-item">
            <router-link to="/demandeur/mes-demandes" class="nav-link" exact-active-class="active">
              <i class="bi bi-file-earmark-text me-2"></i> Mes Demandes
            </router-link>
          </li>
          <li class="nav-item">
            <router-link to="/demandeur/profil" class="nav-link" exact-active-class="active">
              <i class="bi bi-person-circle me-2"></i> Mon Profil
            </router-link>
          </li>
          <li class="nav-item mt-auto">
            <router-link to="/demandeur/Aide" class="nav-link text-danger" exact-active-class="active">
